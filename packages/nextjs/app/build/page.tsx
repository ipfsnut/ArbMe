      ...
      <div className="main-content">
        ...
        <div className="ratchet-info">
          <div className="info-card">
            <h3>How it works</h3>
            <p>$RATCHET is designed to be liquid. It trades against multiple tokens in the ecosystem — CHAOSLP, ARBME, and more. When you stake RATCHET, you earn more RATCHET from protocol emissions while constricting the circulating supply.</p>
