...
export default function TradePage() {
  ...
  const handleApprove = async () => {
    ...
    try {
      if (version === 'V4') {
        // V4 Step 1: ERC20 → Permit2
        // Some tokens (Clanker/Flaunch) have Permit2 hardcoded at infinity — skip if so
        ...
        const checkData = checkRes.ok ? await checkRes.json() : { token0: { needsErc20Approval: true } }
        ...
        // V4 Step 2: Permit2 → Router (only if needed)
  ...
  async function getTokenInfo(address: string): Promise<TokenInfo> {
    const knownTokens: Record<string, { symbol: string; decimals: number }> = {
      ...
      '0x8454d062506a27675706148ecdd194e45e44067a': { symbol: 'CHAOSLP', decimals: 18 },
      ...
      '0xc4730f86d1f86ce0712a7b17ee919db7defad7fe': { symbol: 'PAGE', decimals: 8 },
      '0xf1a7000000950c7ad8aff13118bb7ab561a448ee': { symbol: 'FLAY', decimals: 18 },
