...
async function checkPoolState() {
    ...
    const poolId = keccak256(encodeAbiParameters(parseAbiParameters('address,address,uint24,int24,address'), [poolKey.currency0, poolKey.currency1, poolKey.fee, poolKey.tickSpacing, poolKey.hooks]));
    ...
    const reversedPoolId = keccak256(encodeAbiParameters(parseAbiParameters('address,address,uint24,int24,address'), [reversedPoolKey.currency0, reversedPoolKey.currency1, reversedPoolKey.fee, reversedPoolKey.tickSpacing, reversedPoolKey.hooks]));
